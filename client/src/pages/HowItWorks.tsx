  ...
  return (
    <div className="relative px-4 py-12 text-gray-800 dark:text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          How It <span className="text-[var(--color-secondary-col)]">Works</span>
        </motion.h1>
        ...
        >
          BuildFolio makes capturing and organizing your thoughts effortless with our simple four-step process.
        </motion.p>
      </div>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <motion.div variants={itemVariants} className="relative">
            ...
            >
              ...
              <p className="text-base md:text-lg font-medium text-gray-600 dark:text-gray-300 mb-6">
                Simply fill in your personal details, career experience, education, and skills on the website to get started.
              </p>
              <div ref={svgOneInViewRef} className="flex items-center justify-center h-48 md:h-64 relative">
                ...
                >
                  <img src={steponeSVG} alt="Capture" className="w-full h-full object-contain" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="relative">
            ...
            >
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">AI-Powered Analysis</h3>
              <p className="text-base md:text-lg font-medium text-gray-600 dark:text-gray-300 mb-6">
                Our advanced AI will analyze your resume for ATS compatibility, ensuring it meets industry standards and is optimized for job applications.
              </p>
              <div ref={svgTwoInViewRef} className="flex items-center justify-center h-48 md:h-64 relative">
                <motion.div
                  ...
                  style={{ transformStyle: "preserve-3d" }}
                >
                  <img src={steptwoSVG} alt="Organize" className="w-full h-full object-contain" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="relative">
            ...
            >
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Receive Tailored Suggestions
</h3>
              <p className="text-base md:text-lg font-medium text-gray-600 dark:text-gray-300 mb-6">
                The AI provides personalized suggestions to improve your resume, making it stronger, more relevant, and better suited for job opportunities.
              </p>
              <div ref={svgThreeInViewRef} className="flex items-center justify-center h-48 md:h-64 relative">
                <motion.div
                  ...
                  style={{ transformStyle: "preserve-3d" }}
                >
                  <img src={stepthreeSVG} alt="Connect" className="w-full h-full object-contain" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="relative">
            ...
            >
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Download Your Optimized Resume
</h3>
              <p className="text-base md:text-lg font-medium text-gray-600 dark:text-gray-300 mb-6">
                Once your resume is optimized, easily download it in your preferred format (PDF or DOCX) and be ready to submit to potential employers.
              </p>
              <div ref={svgFourInViewRef} className="flex items-center justify-center h-48 md:h-64 relative">
                <motion.div
                  ...
                  style={{ transformStyle: "preserve-3d" }}
                >
                  <img src={stepfourSVG} alt="Revisit" className="w-full h-full object-contain" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
